...
export const crawl4aiDeepResearchSchema = z.object({
  ...
  query: z
    .string()
    .describe(
      'The research query or topic to investigate in depth. This should be specific enough to guide the research but broad enough to allow for comprehensive coverage'
    ),
  ...
  maxDepth: z
    ...
    .default(3)
    .describe(
      'Maximum depth of research iterations (1-10). Higher values mean more thorough research but longer execution time. Each iteration may explore sub-topics discovered in previous iterations'
    ),
  ...
  maxUrls: z
    ...
    .default(20)
    .describe(
      'Maximum number of URLs to analyze during the research (1-1000). Higher values provide more comprehensive coverage but increase processing time and resource usage'
    ),
  ...
  timeLimit: z
    ...
    .default(120)
    .describe(
      'Maximum time in seconds to spend on the research (30-300). The operation will conclude when either the time limit or URL limit is reached, whichever comes first'
    ),
  ...
  includeDomains: z
    ...
    .optional()
    .describe(
      'List of domains to specifically include in the research (e.g., ["wikipedia.org", "github.com"]). These domains will be prioritized in the search and crawl phases'
    ),
  ...
  excludeDomains: z
    ...
    .optional()
    .describe(
      'List of domains to exclude from the research. No content will be fetched from these domains, useful for avoiding low-quality or irrelevant sources'
    ),
  ...
  responseFormat: z
    ...
    .default('markdown')
    .describe(
      'Preferred format for the research results. "markdown" provides well-formatted content with headers and lists, "json" is structured for programmatic use, and "text" is plain text'
    ),
  ...
  systemInstructions: z
    ...
    .optional()
    .describe(
      'Optional custom instructions for AI systems that analyze the content. This can guide the analysis process, specify output format, or focus on particular aspects of the research'
    ),
  ...
  includeSources: z
    ...
    .default(true)
    .describe(
      'Whether to include source URLs for each piece of information in the response. Setting to true enables attribution and verification of information'
    ),
});
 ...
 */
export type Crawl4aiDeepResearchHandler = (
  params: z.infer<typeof crawl4aiDeepResearchSchema>
